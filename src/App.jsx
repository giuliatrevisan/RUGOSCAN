...
function corrigirRugosidadeINP(inpText, valorPadrao = 100) {
...
function limparSecoesVazias(inpText) {
  const linhas = inpText.split(/\r?\n/);
  const resultado = [];
...
function garantirSecoesObrigatorias(inp) {
  const secoesObrigatorias = ['[OPTIONS]', '[REPORT]', '[TIMES]', '[ENERGY]'];
...
function normalizarINP(original) {
